...
function App() {
 ...
 // ... (all your existing useEffects and digital rain code unchanged – they are perfect)
 ...
 return (
   <>
     ...
     {/* FINAL WORKING TIMELINE – ONLY BUTTON VISIBLE WHEN CLOSED */}
     <div style={{
       position: 'fixed',
       top: '50%',
       right: isTimelineOpen ? '2vw' : '-288px',   // 320px total width – 32px button = 288px hidden
       ...
       {/* THIN GLOWING TAB – ALWAYS VISIBLE */}
       <button
         ...
         style={{
           ...
           fontSize: '20px',
           cursor: 'pointer',
           boxShadow: '-10px 0 30px rgba(0,255,255,0.9)',
